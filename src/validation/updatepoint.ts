...
export const getPointsRules = [
    param('update_id').notEmpty().isInt().withMessage("Param update_id must me an integer"),
];


export const getPointRules = [
    param('update_id').notEmpty().isInt().withMessage("Param update_id must me an integer"),
    param('id').notEmpty().isInt().withMessage("Param id must me an integer"),
];
...
export const createPointRules = [
    ...
    param('update_id').notEmpty().isInt().withMessage("Param update_id must me an integer"),
    param('update_id').custom(async value => {
